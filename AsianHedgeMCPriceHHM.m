function [bid,offer]=AsianHedgeMCPriceHHM(CallPutFlag,s,k,T,t1,sigma,r,b,minunit,nsim,steps,maxvol,n,m,SA,zongsousu,TradingUnit,MarginPercent,CommissionPer,VaR,LVaR)
...
for i=1:a
    commission(i)=-abs(changeP(i))*huazijia(i) * CommissionPer * TradingUnit*exp(-r*(Tstep(1)-Tstep(i)));
end
